    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#FAFAFA] font-sans">
      ...
      <aside className="hidden md:flex flex-col w-[88px] hover:w-64 bg-white text-gray-900 shrink-0 h-screen transition-all duration-300 ease-in-out border-r border-gray-100 shadow-sm group z-50">
        <div className="p-6 pb-2 overflow-hidden flex flex-col h-full">
          <div className="mb-6 mt-2 px-2 flex items-center gap-3 whitespace-nowrap h-8">
             <div className="w-8 h-8 flex items-center justify-center shrink-0 text-[#EA5B0C]">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 12H20M14 6L20 12L14 18" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
               </svg>
             </div>
            ...
            {filteredNavItems.map((item) => (
              ...
              >
                <div className="w-5 flex justify-center shrink-0">
                  <item.icon size={20} strokeWidth={2.5} className={`transition-colors ${currentView === item.id ? 'text-white' : 'text-[#EA5B0C]'}`} />
                </div>
          ...
          <div className="p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 flex items-center justify-center text-[#EA5B0C]">
      ...
      <header className="md:hidden flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100 sticky top-0 z-40">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 flex items-center justify-center text-[#EA5B0C]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 12H20M14 6L20 12L14 18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
